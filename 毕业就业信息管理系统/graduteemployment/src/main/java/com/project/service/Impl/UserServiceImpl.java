...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public ServerResponse checkLogin(String userName, String password) {
        int resultCount = userMapper.checkUserName1(userName);
        if(resultCount == 0 ){
            return ServerResponse.createByErrorMessage("用户名/手机不存在");
        }
