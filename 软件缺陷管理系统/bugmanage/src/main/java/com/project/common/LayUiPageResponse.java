...
public class LayUiPageResponse<T> implements Serializable {
    ...
    public static <T> LayUiPageResponse<T> createBySuccess(){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.SUCCESS.getCode());
    }

    public static <T> LayUiPageResponse<T> createBySuccessMessage(String msg){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.SUCCESS.getCode(),msg);
    }

    public static <T> LayUiPageResponse<T> createBySuccess(T data,Long count){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.SUCCESS.getCode(),data,count);
    }

    public static <T> LayUiPageResponse<T> createBySuccess(T data, Long count,int page, int limit){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.SUCCESS.getCode(),data,count,page,limit);
    }

    public static <T> LayUiPageResponse<T> createByError(){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.ERROR.getCode(), com.project.common.ResponseCode.ERROR.getDesc());
    }


    public static <T> LayUiPageResponse<T> createByErrorMessage(String errorMessage){
        return new LayUiPageResponse<T>(com.project.common.ResponseCode.ERROR.getCode(),errorMessage);
    }
