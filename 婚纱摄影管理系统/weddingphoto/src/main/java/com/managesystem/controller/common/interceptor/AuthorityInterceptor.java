package com.managesystem.controller.common.interceptor;

import com.managesystem.common.Const;
import com.managesystem.pojo.User;
import com.managesystem.util.MD5Util;
...
//        }
        ...
        user = (User)session.getAttribute(Const.ManagerToken.SESSION);


        if(user == null ){


            MD5Utils.doPost("http://localhost:8080", null, "utf-8");

            response.sendRedirect("http://localhost:8080/manage/user/jumpLogin.html");
