...
public class LayUiResponse<T> implements Serializable {
    ...
    public static <T> LayUiResponse<T> createBySuccess(){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.SUCCESS.getCode());
    }

    public static <T> LayUiResponse<T> createBySuccessMessage(String msg){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.SUCCESS.getCode(),msg);
    }

    public static <T> LayUiResponse<T> createBySuccess(List<T> data){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.SUCCESS.getCode(),data);
    }

    public static <T> LayUiResponse<T> createBySuccess(List<T> data,int page,int limit){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.SUCCESS.getCode(),data,page,limit);
    }

    public static <T> LayUiResponse<T> createByError(){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.ERROR.getCode(), com.manage.common.ResponseCode.ERROR.getDesc());
    }


    public static <T> LayUiResponse<T> createByErrorMessage(String errorMessage){
        return new LayUiResponse<T>(com.manage.common.ResponseCode.ERROR.getCode(),errorMessage);
    }
