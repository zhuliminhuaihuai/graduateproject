...
public class SmsSendDemo {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        com.manage.util.SmsSendRequest smsSingleRequest = new com.manage.util.SmsSendRequest(account, password, msg, phone,report);
        ...
        com.manage.util.SmsSendResponse smsSingleResponse = JSON.parseObject(response, com.manage.util.SmsSendResponse.class);
