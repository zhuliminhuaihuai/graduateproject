...
layui.use(['form','element','layer','jquery'],function(){
    ...
    function fillParameter(data){
        ...
        $(".version").text("1.0.1");      //当前版本
        $(".author").text("何泽谭");        //开发作者
        $(".homePage").text("localhost:8080");    //网站首页
        $(".dataBase").text("8.0.23");    //数据库版本
        $(".maxUpload").text("4M");    //最大上传限制
        $(".userRights").text("128");//当前用户权限
    }
