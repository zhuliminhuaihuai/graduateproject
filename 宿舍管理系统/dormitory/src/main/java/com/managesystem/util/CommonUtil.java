...
public class CommonUtil {
     ...
     // 微信参数配置
     public static String API_KEY = com.managesystem.util.WeiChatPayConfig.APP_KEY;
     // 随机字符串生成
    ...
    public static String createSign(String characterEncoding,SortedMap<String, Object> parameters) {
        ...
        String sign = com.managesystem.util.MD5Utils.MD5Encode(sb.toString(), characterEncoding).toUpperCase();
         return sign;
     }
     /**	 * 验证回调签名	 *
      * * @param packageParams
    ...
    // 算出签名
         ...
         if (null == charset || "".equals(charset)) {
            resultSign = com.managesystem.util.MD5Utils.MD5Encode(tobesign, charset).toUpperCase();
         } else {
            resultSign = com.managesystem.util.MD5Utils.MD5Encode(tobesign, charset).toUpperCase();
         }
    ...
    // 退款的请求方法
     public static String httpsRequest2(String requestUrl, String requestMethod,String outputStr) throws Exception {
         ...
         try {
             ...
             httpost.setEntity(entity2);System.out.println("executing request" + httpost.getRequestLine());
